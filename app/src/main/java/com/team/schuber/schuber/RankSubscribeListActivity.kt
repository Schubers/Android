...
class RankSubscribeListActivity: AppCompatActivity() {
    ...
    fun getList() {
        ...
        Network.getNeedApi(this).rankService().enqueue(
                ...
                override fun onResponse(
                    ...
                    when(response.code()) {
                        200 -> {
                            ...
                            subscribe_list_rcv.layoutManager = LinearLayoutManager(this@RankSubscribeListActivity)
                        }
                    }
                }
            }
